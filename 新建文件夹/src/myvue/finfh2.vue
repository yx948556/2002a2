<template>
  <div>
    <header class="header">
      <div class="fd">
        <img src="../imgs/process/logo.png" alt class="log" />
      </div>
      <div class="lxlc fd">装修流程</div>
      <div class="fd gd">
        <div class="fd">
          <div class="iconfont icon-user wd hs"></div>
          <p class="jz hd me">我的</p>
        </div>

        <div class="fd mz">
          <div class="iconfont icon-nav dh hs"></div>
          <p class="jz hd me">导航</p>
        </div>
      </div>
    </header>
    <!-- //红彤彤的图 -->
...
.bghear {
  background: url("../imgs/process/process1.jpg");
  width: 100%;
  height: 2.46rem;
  background-size: 100% 100%;
}
.bg1 {
  background: url("../imgs/process/process2.jpg");
  width: 100%;
  height: 8.55rem;
  background-size: 100% 100%;
}
.bg2 {
  background: url("../imgs/process/process3.png");
  width: 100%;
  height: 8.89rem;
  background-size: 100% 100%;
}
.bg3 {
  background: url("../imgs/process/process4.jpg");
  width: 100%;
  height: 9.49rem;
  background-size: 100% 100%;
}
.bg4 {
  background: url("../imgs/process/process5.jpg");
  width: 100%;
  height: 2.73rem;
  background-size: 100% 100%;
}
